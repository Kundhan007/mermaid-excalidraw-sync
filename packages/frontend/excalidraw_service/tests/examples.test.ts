...
import { CLASS_DIAGRAM_TESTCASES } from "../../web/src/testcases/class.ts";
import { ERD_DIAGRAM_TESTCASES } from "../../web/src/testcases/er.ts";
import { FLOWCHART_DIAGRAM_TESTCASES } from "../../web/src/testcases/flowchart.ts";
import { SEQUENCE_DIAGRAM_TESTCASES } from "../../web/src/testcases/sequence.ts";
import { STATE_DIAGRAM_TESTCASES } from "../../web/src/testcases/state.ts";
import { UNSUPPORTED_DIAGRAM_TESTCASES } from "../../web/src/testcases/unsupported.ts";
